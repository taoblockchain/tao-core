...
const char* ScriptErrorString(const ScriptError serror)
{
    switch (serror)
    {
        ...
        case SCRIPT_ERR_ORDER_INVALID_FLAG:
            return "Order byte flag invalid";
        case SCRIPT_ERR_ORDER_INVALID_DATA:
            return "Order data is invalid";
        case SCRIPT_ERR_PROVENANCE_INVALID_FLAG:
            return "Provenance invalid hash";
        case SCRIPT_ERR_RELEASE_INVALID_HASH:
            return "Release invalid hash";
        case SCRIPT_ERR_EXECUTE_INVALID_FLAG:
            return "Execute invalid hash";
        case SCRIPT_ERR_ESCROW_INVALID_HASH:
            return "Escrow invalid hash";
        case SCRIPT_ERR_ACCEPT_INVALID_HASH:
            return "Accept invalid hash";
        case SCRIPT_ERR_EXPIRE_INVALID_BLOCK_HEIGHT:
            return "Expire block height invalid";
        case SCRIPT_ERR_EXPIRE_INVALID_TIMESTAMP:
            return "Expire timestamp invalid";
        case SCRIPT_ERR_EXPIRE_INVALID_FLAG:
            return "Expire byte flag invalid";
        case SCRIPT_ERR_IDENTIFY_INVALID_FLAG:
            return "Identity byte flag invalid";
        case SCRIPT_ERR_IDENTIFY_INVALID_STRING:
            return "Identity string invalid or missing";
...
const char* GetOpName(opcodetype opcode)
{
    ...
    // Tao
    case OP_IDENTITY                : return "OP_IDENTITY";
    case OP_ORDER                   : return "OP_ORDER";
    case OP_ESCROW                  : return "OP_ESCROW";
    case OP_ACCEPT                  : return "OP_ACCEPT";
    case OP_EXPIRE                  : return "OP_EXPIRE";
    case OP_PROVENANCE              : return "OP_PROVENANCE";
    case OP_EXECUTE                 : return "OP_EXECUTE";
    case OP_RELEASE                 : return "OP_RELEASE";
    case OP_TAO_RESERVED1           : return "OP_TAO_RESERVED1";
    case OP_TAO_RESERVED2           : return "OP_TAO_RESERVED2";
    case OP_TAO_RESERVED3           : return "OP_TAO_RESERVED3";
    case OP_TAO_RESERVED4           : return "OP_TAO_RESERVED4";
    case OP_TAO_RESERVED5           : return "OP_TAO_RESERVED5";
    case OP_TAO_RESERVED6           : return "OP_TAO_RESERVED6";
    case OP_TAO_RESERVED7           : return "OP_TAO_RESERVED7";
    case OP_TAO_RESERVED8           : return "OP_TAO_RESERVED8";
    case OP_TAO_RESERVED9           : return "OP_TAO_RESERVED9";
    case OP_TAO_RESERVED0           : return "OP_TAO_RESERVED0";
...
public:
    ...
    bool operator()(const CEncapsulatedAddress &stxAddr) const
    {
...
public:
    ...
    void operator()(const CEncapsulatedAddress &stxAddr) {
        CScript script;
