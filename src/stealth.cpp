...
bool CEncapsulatedAddress::SetEncoded(const std::string& encodedAddress)
{
    data_chunk raw;
    ...
    {
        if (fDebug)
            LogPrintf("CEncapsulatedAddress::SetEncoded DecodeBase58 falied.\n");
        return false;
    };
    ...
    {
        if (fDebug)
            LogPrintf("CEncapsulatedAddress::SetEncoded verify_checksum falied.\n");
        return false;
    };
    ...
    {
        if (fDebug)
            LogPrintf("CEncapsulatedAddress::SetEncoded() too few bytes provided.\n");
        return false;
    };
    ...
    {
        LogPrintf("CEncapsulatedAddress::SetEncoded version mismatch 0x%x != 0x%x.\n", version, stealth_version_byte);
        return false;
    };
...
std::string CEncapsulatedAddress::Encoded() const
{
    // https://wiki.unsystem.net/index.php/DarkWallet/Encapsulated#Address_format
...
int CEncapsulatedAddress::SetScanPubKey(CPubKey pk)
{
...
int EncapsulatedSecret(ec_secret& secret, ec_point& pubkey, const ec_point& pkSpend, ec_secret& sharedSOut, ec_point& pkOut)
{
    /*
    ...
    */
    ...
    if (!ecgrp)
    {
        LogPrintf("EncapsulatedSecret(): EC_GROUP_new_by_curve_name failed.\n");
        return 1;
    };
    
    if (!(bnCtx = BN_CTX_new()))
    {
        LogPrintf("EncapsulatedSecret(): BN_CTX_new failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecret(): bnEphem BN_bin2bn failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecret(): bnQ BN_bin2bn failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecret(): Q EC_POINT_bn2point failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecret(): eQ EC_POINT_mul failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecret(): bnOutQ incorrect length.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecret(): BN_bin2bn failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecret(): C EC_POINT_new failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecret(): C EC_POINT_mul failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecret(): bnR BN_bin2bn failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecret(): R EC_POINT_bn2point failed\n");
        rv = 1;
        goto End;
    };
    ...
    if (!EC_POINT_mul(ecgrp, C, bnc, NULL, NULL, bnCtx))
    {
        printf("EncapsulatedSecret(): C EC_POINT_mul failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("EncapsulatedSecret(): Rout EC_POINT_new failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecret(): Rout EC_POINT_add failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecret(): Rout EC_POINT_bn2point failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecret(): pkOut incorrect length.\n");
        rv = 1;
        goto End;
    };
...
int EncapsulatedSecretSpend(ec_secret& scanSecret, ec_point& ephemPubkey, ec_secret& spendSecret, ec_secret& secretOut)
{
    /*
    ...
    */
    ...
    if (!ecgrp)
    {
        LogPrintf("EncapsulatedSecretSpend(): EC_GROUP_new_by_curve_name failed.\n");
        return 1;
    };
    
    if (!(bnCtx = BN_CTX_new()))
    {
        LogPrintf("EncapsulatedSecretSpend(): BN_CTX_new failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecretSpend(): bnScanSecret BN_bin2bn failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecretSpend(): bnP BN_bin2bn failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecretSpend(): P EC_POINT_bn2point failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecretSpend(): dP EC_POINT_mul failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecretSpend(): bnOutP incorrect length.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecretSpend(): BN_bin2bn failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecretSpend(): EC_GROUP_get_order failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecretSpend(): bnSpend BN_bin2bn failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecretSpend(): bnSpend BN_mod_add failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecretSpend(): bnSpend is zero.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("EncapsulatedSecretSpend(): bnSpend incorrect length.\n");
        rv = 1;
        goto End;
    };
...
int EncapsulatedSharedToSecretSpend(ec_secret& sharedS, ec_secret& spendSecret, ec_secret& secretOut)
{
    int rv = 0;
    std::vector<uint8_t> vchOutP;
...
bool IsEncapsulatedAddress(const std::string& encodedAddress)
{
    data_chunk raw;
    
    if (!DecodeBase58(encodedAddress, raw))
    {
        //LogPrintf("IsEncapsulatedAddress DecodeBase58 falied.\n");
        return false;
    };
    
    if (!VerifyChecksum(raw))
    {
        //LogPrintf("IsEncapsulatedAddress verify_checksum falied.\n");
        return false;
    };
    
    if (raw.size() < 1 + 1 + 33 + 1 + 33 + 1 + 1 + 4)
    {
        //LogPrintf("IsEncapsulatedAddress too few bytes provided.\n");
        return false;
    };
    ...
    if (version != stealth_version_byte)
    {
        //LogPrintf("IsEncapsulatedAddress version mismatch 0x%x != 0x%x.\n", version, stealth_version_byte);
        return false;
    };
