...
//Dark  features
bool fAlphaNode = false;
string strAlphaNodePrivKey = "";
string strAlphaNodeAddr = "";
bool fLiteMode = false;
bool fEnableInstantX = true;
int nInstantXDepth = 10;
int nDarksendRounds = 2;
int nAnonymizeTaoAmount = 1000;
int nLiquidityProvider = 0;
/** Spork enforcement enabled time */
int64_t enforceAlphanodePaymentsTime = 4085657524;
int nAlphanodeMinProtocol = 0;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Tao
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Tao
    // Mac: ~/Library/Application Support/Tao
    // Unix: ~/.tao
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Tao";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "tao.conf"));
    if (!pathConfigFile.is_complete()) pathConfigFile = GetDataDir(false) / pathConfigFile;
    return pathConfigFile;
}

boost::filesystem::path GetAlphanodeConfigFile()
{
    boost::filesystem::path pathConfigFile(GetArg("-mnconf", "alphanode.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "tao-daemon.pid"));
