...
#ifndef TAO_VERSION_H
#define TAO_VERSION_H
...
// TAO
static const int INTELLITX_VERSION = 0x7400;
...
//! minimum peer version that can receive alphanode payments
static const int MIN_ALPHANODE_PAYMENT_PROTO_VERSION = 61402;
