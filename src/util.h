...
extern bool fAlphaNode;
extern bool fLiteMode;
extern bool fEnableInstantX;
extern int nInstantXDepth;
extern int nDarksendRounds;
extern int nAnonymizeTaoAmount;
extern int nLiquidityProvider;
extern bool fEnableDarksend;
extern int64_t enforceAlphanodePaymentsTime;
extern std::string strAlphaNodeAddr;
extern int nAlphanodeMinProtocol;
...
{
    std::string s = strprintf("tao-%s", name);
