    ...
    transactionView(0)
{
    ...
    typeWidget->addItem(tr("AlphaSent"), TransactionFilterProxy::TYPE(TransactionRecord::AlphaSent));
    typeWidget->addItem(tr("AlphaSend Make Collateral Inputs"), TransactionFilterProxy::TYPE(TransactionRecord::DarksendMakeCollaterals));
    typeWidget->addItem(tr("AlphaSend Create Denominations"), TransactionFilterProxy::TYPE(TransactionRecord::DarksendCreateDenominations));
    typeWidget->addItem(tr("AlphaSend Denominate"), TransactionFilterProxy::TYPE(TransactionRecord::DarksendDenominate));
    typeWidget->addItem(tr("AlphaSend Collateral Payment"), TransactionFilterProxy::TYPE(TransactionRecord::DarksendCollateralPayment));
