...
QString TransactionTableModel::formatTxType(const TransactionRecord *wtx) const
{
    ...
    case TransactionRecord::RecvWithDarksend:
        return tr("Received via AlphaSend");
    ...
    case TransactionRecord::DarksendDenominate:
        return tr("AlphaSend Denominate");
    case TransactionRecord::DarksendCollateralPayment:
        return tr("AlphaSend Collateral Payment");
    case TransactionRecord::DarksendMakeCollaterals:
        return tr("AlphaSend Make Collateral Inputs");
    case TransactionRecord::DarksendCreateDenominations:
        return tr("AlphaSend Create Denominations");
    case TransactionRecord::AlphaSent:
        return tr("AlphaSent");
