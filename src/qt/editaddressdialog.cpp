...
bool EditAddressDialog::saveCurrentRow()
{
    ...
    case NewSendingAddress:
	{
        int typeInd  = ui->stealthCB->isChecked() ? AddressTableModel::AT_Encapsulated : AddressTableModel::AT_Normal;
    ...
    if(!saveCurrentRow())
    {
        ...
        case AddressTableModel::INVALID_ADDRESS:
            QMessageBox::warning(this, windowTitle(),
                tr("The entered address \"%1\" is not a valid Tao address.").arg(ui->addressEdit->text()),
