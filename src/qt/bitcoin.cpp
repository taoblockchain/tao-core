...
#if defined(TAO_NEED_QT_PLUGINS) && !defined(_TAO_QT_PLUGINS_INCLUDED)
#define _TAO_QT_PLUGINS_INCLUDED
#define __INSURE__
#include <QtPlugin>
...
{
    return QCoreApplication::translate("tao-core", psz).toStdString();
}
...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Tao can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    if(GetBoolArg("-testnet", false)) // Separate UI settings for testnet
        app.setApplicationName("Tao-Qt-testnet");
    else
        app.setApplicationName("Tao-Qt");
