...
typedef enum ScriptError_t
{
    ...
    /* IntelliTx Error Codes */
    SCRIPT_ERR_ORDER_INVALID_FLAG, 
    SCRIPT_ERR_ORDER_INVALID_DATA,
    SCRIPT_ERR_PROVENANCE_INVALID_FLAG,
    SCRIPT_ERR_RELEASE_INVALID_HASH,
    SCRIPT_ERR_EXECUTE_INVALID_FLAG,
    SCRIPT_ERR_ESCROW_INVALID_HASH,
    SCRIPT_ERR_ACCEPT_INVALID_HASH,
    SCRIPT_ERR_EXPIRE_INVALID_BLOCK_HEIGHT,
    SCRIPT_ERR_EXPIRE_INVALID_TIMESTAMP,
    SCRIPT_ERR_EXPIRE_INVALID_FLAG,
    SCRIPT_ERR_IDENTIFY_INVALID_FLAG,
    SCRIPT_ERR_IDENTIFY_INVALID_STRING,
 ...
 *  A CTxDestination is the internal data type encoded in a CTaoAddress
 */
typedef boost::variant<CNoDestination, CKeyID, CScriptID, CEncapsulatedAddress> CTxDestination;
...
enum opcodetype
{
    ...
    OP_TAO_RESERVED1 = 0x0a,
    OP_TAO_RESERVED2 = 0x0b,
    OP_TAO_RESERVED3 = 0x0c,
    OP_TAO_RESERVED4 = 0x0d,
    OP_TAO_RESERVED5 = 0x0e,
    OP_TAO_RESERVED6 = 0x0f,
    OP_TAO_RESERVED7 = 0x10,
    OP_TAO_RESERVED8 = 0x11,
    OP_TAO_RESERVED9 = 0x12,
    OP_TAO_RESERVED0 = 0x13,
