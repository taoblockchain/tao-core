...
It is possible to run Tao as a Tor hidden service, and connect to such services.
...
1. Run Tao behind a Tor proxy
---------------------------------

The first step is running Tao behind a Tor proxy. This will already make all
...
config file):
  ...
  HiddenServiceDir /var/lib/tor/tao-service/
...
-externalip=X   You can tell litecoin about its publicly reachable address using
                ...
                /var/lib/tor/tao-service/hostname. Onion addresses are given
