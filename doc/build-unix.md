...
memory available when compiling Tao Core. With 512MB of memory or less
...
If you want to build Tao-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a tao-qt executable will be
built by default.
...
# Pick some path to install BDB to, here we create a directory within the tao directory
...
# Configure Tao Core to use our own-built instance of BDB
cd $TRANSFER_ROOT
./autogen.sh
...
Security
--------
To help make your tao installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, tao should be built with a non-executable stack
