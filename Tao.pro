...
contains(RELEASE, 1) {
    ...
    macx:QMAKE_CXXFLAGS += -mmacosx-version-min=10.12 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk
    macx:QMAKE_CFLAGS += -mmacosx-version-min=10.12 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk  -arch x86_64 -O3
    macx:QMAKE_LFLAGS += -mmacosx-version-min=10.12 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk
    macx:QMAKE_OBJECTIVE_CFLAGS += -mmacosx-version-min=10.12 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk
...
contains(TAO_NEED_QT_PLUGINS, 1) {
    DEFINES += TAO_NEED_QT_PLUGINS
...
QMAKE_CXXFLAGS_WARN_ON = -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector -Wno-deprecated-declarations -Wno-unused-local-typedef
...
HEADERS += src/qt/bitcoingui.h \
    ...
    src/instantx.h \
    src/activealphanode.h \
    src/alphanodeconfig.h \
    src/alphanodeman.h \
    src/alphanode-payments.h \
    src/spork.h \
    src/crypto/common.h \
...
SOURCES += src/qt/bitcoin.cpp src/qt/bitcoingui.cpp \
    ...
    src/rpcdarksend.cpp \
    src/instantx.cpp \
    src/activealphanode.cpp \
    src/alphanodeman.cpp \
    src/alphanode-payments.cpp \
    src/spork.cpp \
    src/alphanodeconfig.cpp \
...
FORMS += \
    ...
    src/qt/forms/alphanodemanager.ui \
