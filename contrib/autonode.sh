...
sudo apt-get install build-essential libssl-dev libdb-dev libdb++-dev libboost-system-dev libboost-filesystem-dev libboost-chrono-dev libboost-program-options-dev libboost-test-dev libboost-thread-dev --force-yes -y
sudo apt-get install git libssl1.0.0-dbg libtool --force-yes -y
sudo apt-get install libdb-dev libdb++-dev libminiupnpc-dev libevent-dev libcrypto++-dev libgmp3-dev --force-yes -y
#
####Install Firewall####
